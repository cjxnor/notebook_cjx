# -*- coding: utf-8 -*-
# 在20250424_vehicle_motion.py的基础上将每段挪库路径封装成函数
import math
import numpy as np
...
center_trajectory, = ax.plot([], [], 'r--')  # 后轴中心点轨迹
fr_trajectory, = ax.plot([], [], 'r--')  # 右前角点轨迹
fl_trajectory, = ax.plot([], [], 'r--')  # 左前角点轨迹
rl_trajectory, = ax.plot([], [], 'r--')  # 左后角点轨迹
rr_trajectory, = ax.plot([], [], 'r--')  # 右后角点轨迹
